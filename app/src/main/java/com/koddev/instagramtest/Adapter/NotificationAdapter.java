...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ImageViewHolder> {
    ...
    @Override
    public NotificationAdapter.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final NotificationAdapter.ImageViewHolder holder, final int position) {
